...
extern class FirebaseRemoteConfig
{
     ...
     */
    static function remoteconfig.init(callback: UNKNOWN): Void;
     ...
     */
    static function remoteconfig.fetch(): Void;
     ...
     */
    static function remoteconfig.activate(): Void;
     ...
     */
    static function remoteconfig.fetch_and_activate(): Void;
     ...
     */
    static function remoteconfig.get_boolean(key: UNKNOWN): Void;
     ...
     * @param key Key of the value to be retrieved 
     */
    static function remoteconfig.get_data(key: UNKNOWN): Void;
     ...
     * @param key Key of the value to be retrieved 
     */
    static function remoteconfig.get_number(key: UNKNOWN): Void;
     ...
     * @param key Key of the value to be retrieved 
     */
    static function remoteconfig.get_string(key: UNKNOWN): Void;
     ...
     */
    static function remoteconfig.get_keys(): Void;
     ...
     */
    static function remoteconfig.set_defaults(defaults: UNKNOWN): Void;
     ...
     */
    static function remoteconfig.set_minimum_fetch_interval(minimum_fetch_interval: UNKNOWN): Void;
}
