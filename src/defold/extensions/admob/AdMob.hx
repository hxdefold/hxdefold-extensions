...
extern class AdMob
{
     ...
     */
    static function set_callback<T>(callback: (self: T, message_id: MessageId, message: Dynamic)->Void): Void;
     ...
     */
    static function load_banner(ad_unit_id: String, size: BannerSize): Void;
     ...
     */
    static function show_banner(position: BannerPosition): Void;
