...
extern class Iap
{
     ...
     */
    static function buy(id: String, options: AnyTable): Void;
     ...
     */
    static function finish(transaction: AnyTable): Void;
     ...
     * @param transaction transaction table parameter as supplied in listener callback 
     */
    static function acknowledge(transaction: AnyTable): Void;
...
- `iap.PROVIDER_ID_FACEBOOK`
     */
    static function get_provider_id(): Int;
     ...
     */
    static function list<T>(ids: AnyTable, callback: (self: T, products: AnyTable, error: AnyTable)->Void): Void;
     ...
     */
    static function set_listener<T>(listener: (self: T, transaction: AnyTable, error: AnyTable)->Void): Void;
}
