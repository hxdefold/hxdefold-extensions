...
extern class Gpgs
{
     ...
     */
    static function set_popup_position(position: Popup): Void;
     ...
     */
    static function snapshot_commit_and_close(metadata: AnyTable): Void;
     ...
     */
    static function snapshot_get_data(): String;
     ...
     */
    static function snapshot_set_data(data: String): Bool;
     ...
     */
    static function snapshot_get_conflicting_data(): String;
