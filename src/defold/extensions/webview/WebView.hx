...
extern class WebView
{
     ...
     */
    static function create<T>(callback: (self: T, webview_id: WebviewId, request_id: RequestId, type: Callback, data: AnyTable)->Void): WebviewId;
     ...
     */
    static function open_raw(webview_id: WebviewId, html: String, options: AnyTable): Void;
     ...
     */
    static function eval(webview_id: WebviewId, code: String): Void;
     ...
     * @param webview_id The webview id
     */
    static function is_visible(webview_id: WebviewId): Bool;
...
extern class WebviewId { }

extern class RequestId { }
