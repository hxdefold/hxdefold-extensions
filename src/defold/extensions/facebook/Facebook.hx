...
extern class Facebook
{
     ...
     */
    static function login_with_permissions<T>(permissions: Array<String>, audience: Audience, callback: (self: T, data: FacebookLoginData)->Void): Void;
     ...
     */
    static function permissions(): Array<String>;
     ...
     */
    static function post_event(event: Event, value: Int, params: Param): Void;
     ...
     */
    static function show_dialog<T>(dialog: Dialog, param: Table<String, String>, callback: (self: T, result: String, error: Bool)->Void): Void;
     ...
     */
    static function deferred_deep_link<T>(callback: (self: T, result: String, error: Bool)->Void): Void;
}
