...
extern class Rive
{
     ...
     */
    static function play_anim<T>(url: Url, anim_id: Hash, playback: Int, options: AnyTable, complete_function: (self: T, message_id: Hash, message: AnyTable, sender: Url)->Void): Void;
     ...
     */
    static function get_go(url: Url, bone_id: Hash): Hash;
}
